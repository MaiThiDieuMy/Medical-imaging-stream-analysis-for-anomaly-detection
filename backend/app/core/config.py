...
class Settings(BaseSettings):
    ...
    retrain_auto_start: bool = False
    training_seed_dir: str = "artifacts/training_seed"
    retrain_include_training_seed: bool = True
    retrain_seed_max_per_class: int = 100
    retrain_output_dir: str = "artifacts/retrained_models"
    retrain_manifest_dir: str = "artifacts/retraining_manifests"
    retraining_manifest_dir: str = "artifacts/retraining_manifests"
    evaluation_set_dir: str = "artifacts/evaluation_set"
    model_promotion_metric: str = "f1_score"
    model_promotion_min_delta: float = 0.0
    model_auto_promote: bool = False
